...
public class CameraSurfaceView extends SurfaceView implements SurfaceHolder.Callback, Camera.AutoFocusCallback, View.OnClickListener {
    ...
    public String getVideoOutputPath() {
        return FileUtil.getMediaOutputPath(videoName);
    }
...
//        startPreview();
        ...
        if (TextUtils.isEmpty(videoName)) {
            videoName = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date(System.currentTimeMillis()));
        }

        mediaRecorder.setOutputFile(FileUtil.getMediaOutputPath(videoName));
        try {
